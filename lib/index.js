...
function plugin(opts) {
  ...
  return function(files, metalsmith, done) {
    ...
    if (topLevelBucket) {
      console.log("Warning! metadata for ", topLevelBucket, " is already set! Continuing...");
    }
    ...
    for (var tag in tagList) {
      ...
      // opts.metadatakey acts as a name for a selection of tags (note the careful wording)
